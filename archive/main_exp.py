...
def calculate():
    ans = convert(num=num_inp.get(), frombase=int(
        old_base_inp.get()), tobase=int(new_base_inp.get()))
...
title_label = Label()
title_label.config(text="Number System Converter", font=(
    "Arial", 24, "bold"), padx=25, pady=25, fg="#bb43bf")
